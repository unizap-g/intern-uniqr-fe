...
const AuthHeader = ({ firstText, secondText }) => {
	return (
        ...
        <h2 className="capitalize  font-bold ">{secondText}</h2>
			...
			<div className="flex flex-wrap ml-1 text-[#065AD8]">
				<h1 className="capitalize text-xl sm:text-2xl md:text-3xl lg:text-4xl">
					{firstText}
				</h1>
				<h2 className="capitalize font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl ml-2">
					{secondText}
				</h2>
			</div>
		</div>

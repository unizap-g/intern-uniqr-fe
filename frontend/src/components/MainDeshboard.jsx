	...
	return (
		<div className="bg-blue-50 w-full md:w-4/5">
          ...
          <MonthOption selectedTime={selectedTime} setselectedTime={setselectedTime} />
				...
				<div className="flex justify-between items-center w-full p-[10px] sm:p-0 gap-2">
					<QrSelect />
					<MonthOption
				...
				<Dashboard1
					scanByOs={DashboardData.scansByOS}
					scanByCountry={DashboardData.scansByCountry}
					scanByCity={DashboardData.scansByCity}
				/>
				...
				<div>
					<Dashboard3
						scanByBrowser={DashboardData.scansByBrowser}
						scanByQrName={DashboardData.scansByQRName}
						scanByTimeOfDay={DashboardData.scansByTimeOfDay}
					/>
				</div>
			</div>
		</div>
